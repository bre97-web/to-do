<template>
    <div class="relative w-full">
        <md-tabs class="sticky top-[0px] z-50">
            ...
            <md-tab v-for="(e, index) in tasks.getCollections" :key="index" @click="setCurrentCollection(e)">{{ e }}</md-tab>
        ...
        <div>
            ...
            <TaskFiltedShower v-else :itemsFilted="[]" :items="tasks.getTasksByCollection(currentCollection)"></TaskFiltedShower>
        </div>
...
import TaskFiltedShower from './TaskFiltedShower.vue';
