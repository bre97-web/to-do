...
const _hoisted_1$c = { class: "tasks" };
const _sfc_main$d = {
  __name: "Task",
  props: {
    title: {
...
const _hoisted_1$b = { class: "text-right" };
const _sfc_main$c = {
...
const _hoisted_1$a = { class: "border dark:border-none bg-transparent dark:bg-slate-700 rounded-md px-4 py-2 my-4" };
const _hoisted_2$9 = { class: "flex flex-row items-end justify-start gap-2" };
const _hoisted_3$8 = /* @__PURE__ */ createBaseVNode("h1", null, "Search", -1);
const _hoisted_4$6 = { class: "underline underline-offset-1" };
const _hoisted_5$6 = ["onClick"];
const _hoisted_6$5 = { class: "desc" };
const _hoisted_7$4 = { class: "flex flex-row gap-2 py-2 buttonGroup" };
const _hoisted_8$4 = ["onClick"];
const _hoisted_9$4 = /* @__PURE__ */ createBaseVNode("i", { class: "material-icons" }, "favorite", -1);
const _hoisted_10$3 = [
  _hoisted_9$4
];
...
const _hoisted_17$2 = { class: "text-right text-gray-500 dark:text-gray-300" };
const _sfc_main$b = {
  __name: "Search",
  props: ["input"],
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return withDirectives((openBlock(), createElementBlock("div", _hoisted_1$a, [
        ...
        createBaseVNode("main", null, [
          ...
          unref(get2).length === 0 ? (openBlock(), createBlock(_sfc_main$c, {
            key: 0,
            input: props.input
          }, null, 8, ["input"])) : createCommentVNode("", true)
        ]),
        createBaseVNode("footer", null, [
          createBaseVNode("p", _hoisted_17$2, " Accumulate " + toDisplayString(unref(get2).length) + " results ", 1)
        ])
      ], 512)), [
...
const _hoisted_1$8 = ["open"];
const _hoisted_2$7 = /* @__PURE__ */ createBaseVNode("div", { slot: "header" }, [
...
const _sfc_main$8 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return isFirstLaunch.value ? (openBlock(), createElementBlock("div", {
        key: 0,
        ref: "dialog",
        class: normalizeClass(["fixed min-h-screen w-full z-50 backdrop-blur-sm bg-black bg-opacity-25", { "hidden ": !isFirstLaunch.value }])
      }, [
...
const _sfc_main$7 = {
  props: {
    ...
    "line-fg-color": {
      type: String,
      default: "#2196f3"
      // match .blue color to Material Design's 'Blue 500' color
    },
    "speed": {
      type: Number,
      default: 0.8
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", null, [
    createBaseVNode("div", {
      ...
      style: normalizeStyle($options.spinner_style)
    }, null, 4),
    $props.message.length > 0 ? (openBlock(), createElementBlock("div", {
      key: 0,
      class: "vue-simple-spinner-text",
      style: normalizeStyle($options.text_style)
    }, toDisplayString($props.message), 5)) : createCommentVNode("", true)
  ]);
}
const Spinner = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render]]);
const Loading_vue_vue_type_style_index_0_scoped_0bb8c3bd_lang = "";
const _withScopeId$1 = (n2) => (pushScopeId("data-v-0bb8c3bd"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$6 = { id: "loading" };
const _hoisted_2$6 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("img", {
  src: _imports_0,
  alt: "To-Do",
  class: "max-w-xs"
}, null, -1));
const _hoisted_3$6 = /* @__PURE__ */ _withScopeId$1(() => /* @__PURE__ */ createBaseVNode("h1", null, "To-Do", -1));
const _sfc_main$6 = {
  __name: "Loading",
  setup(__props) {
    return (_ctx, _cache) => {
...
const Loading = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["__scopeId", "data-v-0bb8c3bd"]]);
const _hoisted_1$5 = {
  key: 1,
  id: "root",
...
const _hoisted_6$4 = /* @__PURE__ */ createBaseVNode("i", { class: "material-icons relative left-10" }, "search", -1);
const _hoisted_7$3 = ["value:"];
const _hoisted_8$3 = { class: "setting" };
const _hoisted_9$3 = /* @__PURE__ */ createBaseVNode("md-text-button", { label: "Settings" }, null, -1);
...
const _hoisted_16$1 = { class: "space-y-2" };
const _hoisted_17$1 = /* @__PURE__ */ createBaseVNode("h1", null, "Theme", -1);
const _hoisted_18$1 = { class: "pt-24 min-h-screen" };
const _hoisted_19$1 = { class: "fab" };
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return !isLoaded.value ? (openBlock(), createBlock(Loading, {
        ...
        createBaseVNode("main", _hoisted_18$1, [
          createVNode(_sfc_main$b, { input: unref(input) }, null, 8, ["input"]),
        ...
        createBaseVNode("nav", null, [
          createBaseVNode("div", _hoisted_19$1, [
            createBaseVNode("md-fab-extended", {
              ...
              onClick: _cache[2] || (_cache[2] = ($event) => dialog.open = true)
            }, _hoisted_21$1, 2),
...
const _hoisted_4$3 = { class: "flex flex-row gap-2 py-2 buttonGroup" };
const _hoisted_5$3 = ["onClick"];
const _hoisted_6$3 = /* @__PURE__ */ createBaseVNode("i", { class: "material-icons" }, "favorite", -1);
const _hoisted_7$2 = [
  _hoisted_6$3
];
const _hoisted_8$2 = ["onClick"];
const _hoisted_9$2 = { class: "desc" };
...
const _hoisted_18 = { class: "flex flex-row gap-2 py-2 buttonGroup" };
const _hoisted_19 = ["onClick"];
const _hoisted_20 = /* @__PURE__ */ createBaseVNode("i", { class: "material-icons" }, "delete_forever", -1);
const _hoisted_21 = [
  _hoisted_20
];
...
const _hoisted_1$3 = { class: "flex flex-row" };
...
const _hoisted_7$1 = /* @__PURE__ */ createBaseVNode("div", { slot: "header" }, [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1$3, [
        info.avatar_path.length !== 0 ? (openBlock(), createElementBlock("header", _hoisted_2$3, [
          createBaseVNode("img", {
...
const Me_vue_vue_type_style_index_0_scoped_4f659d60_lang = "";
const _withScopeId = (n2) => (pushScopeId("data-v-4f659d60"), n2 = n2(), popScopeId(), n2);
const _hoisted_1$2 = { class: "mt-12 relative" };
const _hoisted_2$2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("header", null, [
...
const _hoisted_6$1 = { class: "tasks" };
const _hoisted_7 = { class: "list" };
const _hoisted_8 = {
  key: 0,
  class: "list-inner-page"
};
const _hoisted_9 = { class: "tasks" };
const _hoisted_10 = { class: "list" };
const _hoisted_11 = {
  key: 0,
  class: "list-inner-page"
};
const _hoisted_12 = { class: "tasks" };
const _hoisted_13 = { class: "mt-12 mb-2" };
const _hoisted_14 = { class: "group" };
const _hoisted_15 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("h1", null, "Helper", -1));
const _sfc_main$2 = {
  __name: "Me",
  setup(__props) {
    const tasks = useTasks();
            ...
            createBaseVNode("main", _hoisted_3$2, [
              createBaseVNode("ul", null, [
                createBaseVNode("li", _hoisted_4$1, [
                  ...
                  unref(tasks).taskList.getValues().length != 0 ? (openBlock(), createElementBlock("div", _hoisted_5$1, [
                ...
                createBaseVNode("li", _hoisted_7, [
                  ...
                  unref(tasks).binList.getValues().length != 0 ? (openBlock(), createElementBlock("div", _hoisted_8, [
                ...
                createBaseVNode("li", _hoisted_10, [
                  ...
                  unref(tasks).focusList.getValues().length != 0 ? (openBlock(), createElementBlock("div", _hoisted_11, [
...
const Me = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4f659d60"]]);
const Helper_vue_vue_type_style_index_0_scoped_794a0931_lang = "";
const _hoisted_1$1 = { class: "relative border rounded-md px-4 py-2" };
const _hoisted_2$1 = { class: "absolute right-1 top-1" };
const _hoisted_3$1 = /* @__PURE__ */ createStaticVNode('<header data-v-794a0931><h1 data-v-794a0931>Help</h1><p data-v-794a0931>你将从这里学习到使用本网页的技能！</p></header><main data-v-794a0931><ol class="list-decimal" data-v-794a0931><li data-v-794a0931><h1 data-v-794a0931>创建一个任务</h1></li><p data-v-794a0931>注意页面顶部的输入框，在输入框中键入Created a task（或者键入你想要的字符），键入完毕后按下输入框旁的添加按钮（或者按下键盘的Enter键）以创建一个任务。</p><li data-v-794a0931><h1 data-v-794a0931>完成一个任务</h1></li><p data-v-794a0931>你会发现此栏目新增了一个Created a task任务。</p><p data-v-794a0931>点击任务旁的方形按钮以完成此任务。当任务完成时它将出现Bin栏目，此栏目中会出现你刚才完成的任务。如果你需要取消任务的完成状态请点击Undo按钮。</p><li data-v-794a0931><h1 data-v-794a0931>删除一个任务</h1></li><p data-v-794a0931>当你点击在任务旁的Remove按钮后，任务将立即被永久删除且无法还原。</p><li data-v-794a0931><h1 data-v-794a0931>置顶一个任务</h1></li><p data-v-794a0931>注意任务旁的爱心形状的按钮，点击后任务将会出现在Focus栏目中置顶，当再次点击爱心形状的按钮后取消置顶。</p></ol></main>', 2);
const _sfc_main$1 = {
  __name: "Helper",
  setup(__props) {
    const router = useRouter();
...
const Helper = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-794a0931"]]);
 ...
 */
var n$6;
const e$6 = null != (null === (n$6 = window.HTMLSlotElement) || void 0 === n$6 ? void 0 : n$6.prototype.assignedElements) ? (o3, n2) => o3.assignedElements(n2) : (o3, n2) => o3.assignedNodes(n2).filter((o4) => o4.nodeType === Node.ELEMENT_NODE);
function l$6(n2) {
 ...
 */
var s$4;
const e$4 = window, r$1 = e$4.trustedTypes, h$1 = r$1 ? r$1.emptyScript : "", o$3 = e$4.reactiveElementPolyfillSupport, n$4 = { toAttribute(t2, i3) {
  switch (i3) {
    case Boolean:
      t2 = t2 ? h$1 : null;
      break;
  ...
  return s3;
} }, a$2 = (t2, i3) => i3 !== t2 && (i3 == i3 || t2 == t2), l$5 = { attribute: true, type: String, converter: n$4, reflect: false, hasChanged: a$2 };
let d$1 = class d extends HTMLElement {
  ...
  static createProperty(t2, i3 = l$5) {
  ...
  _$EO(t2, i3, s3 = l$5) {
    ...
    if (void 0 !== r2 && true === s3.reflect) {
      const h2 = (void 0 !== (null === (e2 = s3.converter) || void 0 === e2 ? void 0 : e2.toAttribute) ? s3.converter : n$4).toAttribute(i3, s3.type);
 ...
 */
var t$1;
const i$3 = window, s$3 = i$3.trustedTypes, e$3 = s$3 ? s$3.createPolicy("lit-html", { createHTML: (t2) => t2 }) : void 0, o$2 = "$lit$", n$3 = `lit$${(Math.random() + "").slice(9)}$`, l$4 = "?" + n$3, h = `<${l$4}>`, r = document, d2 = () => r.createComment(""), u = (t2) => null === t2 || "object" != typeof t2 && "function" != typeof t2, c = Array.isArray, v = (t2) => c(t2) || "function" == typeof (null == t2 ? void 0 : t2[Symbol.iterator]), a$1 = "[ 	\n\f\r]", f$1 = /<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g, _ = /-->/g, m = />/g, p = RegExp(`>|${a$1}(?:([^\\s"'>=/]+)(${a$1}*=${a$1}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`, "g"), g = /'/g, $ = /"/g, y = /^(?:script|style|textarea|title)$/i, w = (t2) => (i3, ...s3) => ({ _$litType$: t2, strings: i3, values: s3 }), x = w(1), T = Symbol.for("lit-noChange"), A = Symbol.for("lit-nothing"), E = /* @__PURE__ */ new WeakMap(), C = r.createTreeWalker(r, 129, null, false), P = (t2, i3) => {
  ...
  for (let i4 = 0; i4 < s3; i4++) {
    ...
    d3 += u2 === f$1 ? s4 + h : v2 >= 0 ? (l2.push(e2), s4.slice(0, v2) + o$2 + s4.slice(v2) + n$3 + w2) : s4 + n$3 + (-2 === v2 ? (l2.push(void 0), i4) : w2);
  }
      ...
      if (1 === h2.nodeType) {
        if (h2.hasAttributes()) {
          ...
          for (const i4 of h2.getAttributeNames())
            if (i4.endsWith(o$2) || i4.startsWith(n$3)) {
              const s3 = f2[u2++];
              if (t3.push(i4), void 0 !== s3) {
                const t4 = h2.getAttribute(s3.toLowerCase() + o$2).split(n$3), i5 = /([.?@])?(.*)/.exec(s3);
...
class S {
  ...
  v(t2) {
    ...
    for (; void 0 !== d3; ) {
      if (l2 === d3.index) {
        let i4;
        2 === d3.type ? i4 = new M(n2, n2.nextSibling, this, t2) : 1 === d3.type ? i4 = new d3.ctor(n2, d3.name, d3.strings, this, t2) : 6 === d3.type && (i4 = new z(n2, this, t2)), this.u.push(i4), d3 = e2[++h2];
      }
...
class M {
  constructor(t2, i3, s3, e2) {
    var o3;
    this.type = 2, this._$AH = A, this._$AN = void 0, this._$AA = t2, this._$AB = i3, this._$AM = s3, this.options = e2, this._$Cm = null === (o3 = null == e2 ? void 0 : e2.isConnected) || void 0 === o3 || o3;
  }
  get _$AU() {
    var t2, i3;
  ...
  _$AI(t2, i3 = this) {
    t2 = N(this, t2, i3), u(t2) ? t2 === A || null == t2 || "" === t2 ? (this._$AH !== A && this._$AR(), this._$AH = A) : t2 !== this._$AH && t2 !== T && this.g(t2) : void 0 !== t2._$litType$ ? this.$(t2) : void 0 !== t2.nodeType ? this.T(t2) : v(t2) ? this.k(t2) : this.g(t2);
  }
  S(t2) {
  ...
  $(t2) {
    ...
    if ((null === (i3 = this._$AH) || void 0 === i3 ? void 0 : i3._$AD) === o3)
      ...
      const t3 = new S(o3, this), i4 = t3.v(this.options);
  ...
  k(t2) {
    ...
    let s3, e2 = 0;
    for (const o3 of t2)
      e2 === i3.length ? i3.push(s3 = new M(this.S(d2()), this.S(d2()), this, this.options)) : s3 = i3[e2], s3._$AI(o3), e2++;
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const o2 = e$2(class extends i$2 {
  constructor(t$12) {
    var i3;
  ...
  update(i3, [s3]) {
    var r2, o3;
    if (void 0 === this.nt) {
      this.nt = /* @__PURE__ */ new Set(), void 0 !== i3.strings && (this.st = new Set(i3.strings.join(" ").split(/\s/).filter((t2) => "" !== t2)));
      for (const t2 in s3)
        s3[t2] && !(null === (r2 = this.st) || void 0 === r2 ? void 0 : r2.has(t2)) && this.nt.add(t2);
      return this.render(s3);
    }
    const e2 = i3.element.classList;
    this.nt.forEach((t2) => {
      t2 in s3 || (e2.remove(t2), this.nt.delete(t2));
    });
    for (const t2 in s3) {
      const i4 = !!s3[t2];
      i4 === this.nt.has(t2) || (null === (o3 = this.st) || void 0 === o3 ? void 0 : o3.has(t2)) || (i4 ? (e2.add(t2), this.nt.add(t2)) : (e2.remove(t2), this.nt.delete(t2)));
    }
    return T;
  }
});
...
class Button extends s$2 {
  ...
  render() {
    return x`
      <button
          class="md3-button ${o2(this.getRenderClasses())}"
  ...
  render() {
    return x`
      <span class="md3-link-button-wrapper">
        <a class="md3-button ${o2(this.getRenderClasses())}"
          href="${l$2(this.href)}"
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdElevatedLinkButton = class MdElevatedLinkButton2 extends ElevatedLinkButton {
};
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFilledLinkButton = class MdFilledLinkButton2 extends FilledLinkButton {
};
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdOutlinedLinkButton = class MdOutlinedLinkButton2 extends OutlinedLinkButton {
};
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdTextLinkButton = class MdTextLinkButton2 extends TextLinkButton {
};
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdTonalLinkButton = class MdTonalLinkButton2 extends TonalLinkButton {
};
...
class IconButton extends s$2 {
  ...
  render() {
    return x`<button
        class="md3-icon-button ${o2(this.getRenderClasses())}"
        aria-label="${l$2(this.ariaLabel)}"
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFilledLinkIconButton = class MdFilledLinkIconButton2 extends LinkIconButton {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFilledIconButtonToggle = class MdFilledIconButtonToggle2 extends IconButtonToggle {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
      "md3-icon-button--filled": true,
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFilledTonalIconButtonToggle = class MdFilledTonalIconButtonToggle2 extends IconButtonToggle {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
      "md3-icon-button--filled-tonal": true,
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFilledTonalLinkIconButton = class MdFilledTonalLinkIconButton2 extends LinkIconButton {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
      "md3-icon-button--filled-tonal": true
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdStandardIconButtonToggle = class MdStandardIconButtonToggle2 extends IconButtonToggle {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
      "md3-icon-button--standard": true
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdStandardLinkIconButton = class MdStandardLinkIconButton2 extends LinkIconButton {
  getRenderClasses() {
    return {
      ...super.getRenderClasses(),
      "md3-icon-button--standard": true
...
class FabShared extends s$2 {
  ...
  render() {
    ...
    return x`
      <button
        class="md3-fab md3-surface ${o2(this.getRenderClasses())}"
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
let MdFabExtended = class MdFabExtended2 extends FabExtended {
  /** @soyTemplate */
  renderIcon(icon) {
    return icon ? x`<md-icon class="md3-fab__icon">${icon}</md-icon>` : "";
  }
...
class Switch extends s$2 {
  ...
  render() {
    ...
    return x`
      <button
        type="button"
        class="md3-switch ${o2(this.getRenderClasses())}"
        role="switch"
  ...
  renderHandle() {
    ...
    return x`
      <span class="md3-switch__handle-container">
        ${n$1(this.showRipple, this.renderRipple)}
        <span class="md3-switch__handle ${o2(classes)}">
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
const i2 = e$2(class extends i$2 {
  constructor(t$12) {
    var e2;
...
class TextField extends s$2 {
  ...
  render() {
    ...
    return x`
       <span class="text-field ${o2(classes)}">
         ${this.renderField()}
       </span>
     `;
  }
  ...
  renderAffix(text, isSuffix) {
    ...
    return x`<span class="${o2(classes)}">${text}</span>`;
  }
...
class Badge extends s$2 {
  ...
  /** @soyTemplate */
  render() {
    return x`<div class="md3-badge ${o2(this.getRenderClasses())}"><p class="md3-badge__value">${this.value}</p></div>`;
  }
  /** @soyTemplate */
  getRenderClasses() {
    return {
...
class NavigationTab extends ActionElement {
  ...
  render() {
    return x`
      <button
        class="md3-navigation-tab ${o2(this.getRenderClasses())}"
        role="tab"
...
class List extends s$2 {
  ...
  renderList() {
    return x`
    <ul class="md3-list ${o2(this.getListClasses())}"
        aria-label="${l$2(this.ariaLabel)}"
...
class ListItemEl extends s$2 {
  ...
  renderSupportingText() {
    return x`<span
        class="supporting-text ${o2(this.getSupportingTextClasses())}"
  ...
  renderSurface() {
    return x`
       <div
           ...
           style=${i2(this.menuPositionController.surfaceStyles)}>
        ${this.renderList()}
        ${this.renderElevation()}
        ${this.renderFocusRing()}
       </div>
